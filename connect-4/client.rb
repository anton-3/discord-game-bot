...
module Connect4
  ...
  class Client < DiscordGame
    ...
    def reaction_add(evt)
      ...
      user_id = evt.message.content[2, 18].to_i
      ...
      game = player.game
      return unless game.whose_turn == player && game.legal_move?(move)
    ...
    def start_game(msg, user1, user2)
      ...
      game = Connect4::Game.new user1, user2, randomize: RANDOM_STARTING_PLAYER, which_ai: which_ai
      @game_msg_ids[game] = []
